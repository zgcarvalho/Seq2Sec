...
if __name__ == '__main__':
    ...
    # train('data/config/data_test.json','models/teste-uncloss-ss3_ss4_buried.pth', epochs=100)
    train('data/config/data_cath95.json','models/resnet_uncertloss_dropout_cath95_ss3-ss4-buried.pth', device='cuda', epochs=200)
